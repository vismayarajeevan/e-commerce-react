...
// const Header = ({ insideHome,product }) => {
    ...
    <nav className="fixed w-full bg-gradient-to-r from-blue-800 to-indigo-900 shadow-lg z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-6">
            {isLoggedIn && (
              <div className="flex md:hidden items-center space-x-6 mr-4">
                <Link to="/wishlist" className="text-white hover:text-white/90 transition">
                  <Heart className="h-6 w-6" />
                </Link>
                <Link to="/cart" className="text-white hover:text-white/90 transition">
